...
class log_packet : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:log_packet) */ {
 public:
  ...
  inline log_packet* New() const { return New(NULL); }

  log_packet* New(::google::protobuf::Arena* arena) const;
  ...
  bool has_log_micro_sec() const;
  void clear_log_micro_sec();
  static const int kLogMicroSecFieldNumber = 2;
  ::google::protobuf::uint32 log_micro_sec() const;
  void set_log_micro_sec(::google::protobuf::uint32 value);

  // required fixed32 sequence_no = 3;
  bool has_sequence_no() const;
  void clear_sequence_no();
  static const int kSequenceNoFieldNumber = 3;
  ::google::protobuf::uint32 sequence_no() const;
  void set_sequence_no(::google::protobuf::uint32 value);

  // required fixed32 shm_app_id = 4;
  bool has_shm_app_id() const;
  void clear_shm_app_id();
  static const int kShmAppIdFieldNumber = 4;
  ::google::protobuf::uint32 shm_app_id() const;
  void set_shm_app_id(::google::protobuf::uint32 value);
